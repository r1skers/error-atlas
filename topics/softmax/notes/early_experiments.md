# Early Softmax Experiments (historical)

> Preserved notes for the shift-resolution, summation and exact-oracle stages.
> Filenames below refer to `topics/softmax/experiments/`; commands run from the repository root.
> Use the [experiment index](../experiments/README.md) for current navigation.
